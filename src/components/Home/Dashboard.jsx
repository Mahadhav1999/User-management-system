        ...
        <div>
          <div>
            <div
              style={{
                background:
                  "url(https://image.freepik.com/free-vector/mobile-user-banner_82984-210.jpg) 0% 0% / cover no-repeat",
                height: "250px",
              }}
            ></div>
            <div class="px-4 py-5 md:px-6 lg:px-8 surface-section">
              ...
              >
                <div>
                  <div
                    class="mb-3 surface-card shadow-2 flex align-items-center justify-content-center"
                    style={{
                      width: "140px",
                      height: "140px",
                      borderRadius: "10px",
                  ...
                  <div class="text-600 font-medium">
                    <span>Website | India </span>
                  </div>
                </div>
                <div class="mt-3 lg:mt-0">
                  <button
                    aria-label="Follow"
                    class="p-button p-component p-button-outlined mr-2"
                  >
                  ...
                  <button class="p-button p-component p-button-outlined p-button-rounded p-button-icon-only">
                    <span class="p-button-icon p-c pi pi-ellipsis-v"></span>
