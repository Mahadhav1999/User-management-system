        ...
        <div className="block-content">
            <div className="flex">
                <div className="w-full md:w-6 p-6 md:p-8">
                    <div className="mb-5">
                        <img src="https://static.thenounproject.com/png/95188-200.png" alt="admin" height="55" className="mb-3" />
                ...
                style={{ background: 'url(https://img.freepik.com/free-vector/flat-design-illustration-customer-support_23-2148887720.jpg?w=740&t=st=1678797882~exp=1678798482~hmac=5ba89a40e6b25c062b7477efe7e8b75bb4fb722e329d9da817914509fc53537b)' 
                }}>
                </div>
            </div>
        </div>
