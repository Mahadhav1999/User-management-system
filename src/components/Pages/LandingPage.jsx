          ...
          <div className="col-12 md:col-6 p-6 text-center md:text-left">
            <section>
              ...
              <p className="mt-0 mb-4 text-700 line-height-4">
                ...
                ipsa iste quia voluptatibus molestiae illum facere sed. Eius
                numquam harum laudantium quae sint atque consequatur unde.
              </p>
              ...
              <div className="flex gap-3">
                <Link to="/auth/admin/login" className="no-underline">
                  <button
                    ...
                    type="button"
                    class="p-button p-component z-2"
                  >
                    <span class="p-button-icon p-c p-button-icon-right pi pi-box mx-2"></span>
                ...
                <Link to="/auth/user/login" className="no-underline">
                  <button
                    ...
                    type="button"
                    class="p-button p-component p-button-outlined z-2"
                  >
