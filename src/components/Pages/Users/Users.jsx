  ...
  const rightToolbarTemplate = () => {
    return (
      <div className="flex flex-wrap gap-2">
        <Button label="Delete" icon="pi pi-trash" className='p-button p-button-danger p-button-outlined' severity="danger" onClick={confirmDeleteSelected} disabled={!selectedUsers || !selectedUsers.length} />
    ...
    return (
      <React.Fragment>
        <Button
          ...
          onClick={() => { navigate(`/admin/dashboard/edit/${rowData.id}/user`) }} />
        <Button
          icon="pi pi-trash"
    ...
    <div>
      <div className="card">
        ...
        >
          ...
          <Column field="created_at" header="Created At" sortable body={createdAt} style={{ minWidth: '9rem' }}></Column>

          <Column field="name" header="Name" body={usernameBodyTemplate} sortable style={{ minWidth: '12rem' }}></Column>
          <Column field="email" header="Email" sortable style={{ minWidth: '14rem' }}></Column>
          <Column field="gender" header="Gender" sortable style={{ minWidth: '9rem' }}></Column>
          <Column field="age" header="Age" sortable style={{ minWidth: '7rem' }}></Column>
